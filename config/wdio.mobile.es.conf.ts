...
export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        app: './app/dev-DRIVER-APP-POC-62.apk',
        appPackage: 'com.driverapprewritepoc',  // Package name of your app
        appActivity: 'com.driverapprewritepoc.MainActivity', // App activity of the app
