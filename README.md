...
# Mobile test automation framework with support to interact with APIs

Mobile test automation framework based on Cucumber - WebdriverIO - NodeJS - TypeScript - Axios - Allure Reports / JUnit Report. With support to run both locally and in cloud services such as BrowserStack.

## Table of contents

- [Mobile test automation framework with support to interact with APIs](#mobile-test-automation-framework-with-support-to-interact-with-apis)
...
- Go to [official website JDK](https://www.oracle.com/sa/java/technologies/javase/downloads/), go to *Java SE Development Kit* download and install the latest version.
